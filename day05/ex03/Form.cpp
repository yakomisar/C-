...
Form::Form(std::string const &target, std::string name, int grade_to_sign, int grade_to_exec) : target(target), name(name), is_signed(false), grade_to_sign(grade_to_sign), grade_to_exec(grade_to_exec)
{
